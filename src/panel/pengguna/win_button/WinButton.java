package panel.pengguna.win_button;

import panel.pengguna.component.Background;
...
public class WinButton extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdClose = new panel.pengguna.win_button.Button();
        cmdMi = new panel.pengguna.win_button.Button();
        cmdRe = new panel.pengguna.win_button.Button();
    ...
    private panel.pengguna.win_button.Button cmdClose;
    private panel.pengguna.win_button.Button cmdMi;
    private panel.pengguna.win_button.Button cmdRe;
