 ...
 */
public class PengadaanObatCard extends javax.swing.JPanel {
    ...
    public PengadaanObatCard(PengadaanObat pengadaanObat) {
        initComponents();
        ...
        initLeftPic("default");
        initBtn();
        initAttributeAndLabel(pengadaanObat.getTanggalPengadaan(), pengadaanObat.getObat().getNamaObat(), String.valueOf(pengadaanObat.getKuantitas()));
    }

    public void initAttributeAndLabel(String tgl, String namaObat, String jmlObat) {
        lblTglPengadaan.setText(tgl);
    ...
    public void initLeftPic(String jenis) {
        ...
        if (jenis.equalsIgnoreCase("default")) {
            icon = new FlatSVGIcon("img/icon/package.svg", 1.4f);
        }
    ...
    private void initComponents() {
        ...
        lblTglPengadaan = new javax.swing.JLabel();
        ...
        lblTglPengadaan.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblTglPengadaan.setForeground(new java.awt.Color(255, 255, 255));
        lblTglPengadaan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblTglPengadaan.setText("tglPengadaan");
        infoPanel.add(lblTglPengadaan, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, -1, -1));
    ...
    private javax.swing.JLabel lblTglPengadaan;
